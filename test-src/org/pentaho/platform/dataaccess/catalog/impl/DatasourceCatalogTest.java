...
public class DatasourceCatalogTest {
  ...
  public void testGetDatasources() {
    IDatasource datasource1 = new Datasource("datasource1",
        new MockDatasourceType("1"));
    IDatasource datasource2 = new Datasource("datasource2",
        new MockDatasourceType("1"));
  ...
  public void testGetDatasourcesOfType() {
    ...
    IDatasource datasource3 = new Datasource("datasource3",
        new MockDatasourceType("2"));
    IDatasource datasource4 = new Datasource("datasource4",
        new MockDatasourceType("2"));
