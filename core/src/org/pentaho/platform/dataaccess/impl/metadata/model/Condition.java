...
import org.pentaho.platform.dataaccess.api.metadata.model.ICondition;
import org.pentaho.platform.dataaccess.api.metadata.model.Operator;
...
public class Condition implements ICondition {
   ...
   * 
   * public void setParameterized(boolean parameterized) { this.parameterized = parameterized; } / public void
   * setDefaultValue(String val){ this.defaultValue = val; }
   * 
   * public String getDefaultValue(){ return this.defaultValue; }
   * 
   * public void setSelectedAggType(String aggType){ this.selectedAggType = aggType; }
   * 
   * public String getSelectedAggType(){ return this.selectedAggType; }
   */
