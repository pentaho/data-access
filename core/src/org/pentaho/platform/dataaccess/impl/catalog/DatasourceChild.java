...
import org.pentaho.platform.dataaccess.api.catalog.IDatasourceChild;

/**
 * Provides the structure for a hierarchy of children that belong to a
 * datasource.
 * 
 * @author wseyler
 */
...
public class DatasourceChild implements IDatasourceChild {
	...
	private String id;
	private String name;
	private List<DatasourceChild> children;
	 ...
	 * 
	 * @see
	 * org.pentaho.platform.dataaccess.catalog.api.IDatasourceChild#getName()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.pentaho.platform.dataaccess.catalog.api.IDatasourceChild#getChildren
	 * ()
	 */
	@Override
