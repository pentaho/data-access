...
import org.pentaho.platform.dataaccess.impl.catalog.dto.DatasourceListDto;
import org.pentaho.platform.dataaccess.impl.catalog.dto.DatasourceTypesListDto;

/**
 * Datasource Catalog is a datasource listing service, which finds IDatasource
 * object by consulting the IDatasourceProvider(s) registered with it.
 * 
 * @author wseyler
 * 
 */
...
public class DatasourceCatalog implements IDatasourceCatalog {
	 ...
	 * 
	 * @see
	 * org.pentaho.platform.dataaccess.catalog.api.IDatasourceCatalog#getDatasources
	 * ()
	 */
	@Override
	...
	/**
	 * Returns a list of IDatasourceTypes that can be further used to lookup
	 * datasources of a specific type.
	 * 
	 * @return a JaxbList of IDatasourceType implementations (usually
	 *         DatasourceType) suitable for serialization by Jersey
	 */
	@GET
	@Path("/getDatasources")
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.pentaho.platform.dataaccess.catalog.api.IDatasourceCatalog#
	 * getDatasourcesOfType(org.pentaho.platform.dataaccess
	 ...
	 *            - the type of the datasources to return (typically an instance
	 *            of DatasourceType)
	 * @return A JaxbList of concrete instances of the type 'IDatasourceType'
	 *         (typically DatasourceType)
	 */
	@POST
	@Path("/getDatasourcesByType")
	@Consumes({ APPLICATION_JSON, APPLICATION_XML })
	@Produces({ APPLICATION_JSON, APPLICATION_XML })
	public DatasourceListDto getDatasourcesOfTypeAsJaxbList(
			IDatasourceType datasourceType) {
	 ...
	 * 
	 * @return A JaxbList of concrete instances of IDatasourceType (typically
	 *         DatasourceType) suitable for serialization by Jersey
	 */
	@GET
	...
	public void registerDatasourceProvider(
