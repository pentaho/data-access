...
/**
 * Datasource Catalog is a datasource listing service, which finds IDatasource object by consulting the
 * IDatasourceProvider(s) registered with it.
 * 
 * @author wseyler
 * 
 */
...
public class DatasourceCatalog implements IDatasourceCatalog {
   ...
   * 
   * @return A DatasourceTypesListDto of concrete instances of DatasourceType suitable for serialization by Jersey
   */
  @GET
