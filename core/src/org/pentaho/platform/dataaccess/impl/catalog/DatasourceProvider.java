...
/**
 * An implementation of IDatasourceProvider where one instance represents one
 * type of datasource that has been registered by the system.
 * 
 * @author wseyler
 */
public class DatasourceProvider implements IDatasourceProvider {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.pentaho.platform.dataaccess.catalog.api.IDatasourceProvider#
	 * getDatasources()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.pentaho.platform.dataaccess.catalog.api.IDatasourceProvider#getType()
	 */
	@Override
