...
public class DSWDataSourceWizard implements IDSWDataSourceWizard {
  ...
  public IDSWTemplate getTemplateByID(String templateID) {
    //This doesn't work yet with unit test -- PentahoSystem.get(IDSWTemplate.class, PentahoSessionHolder.getSession(), Collections.singletonMap("DSWTemplateType", templateId));
