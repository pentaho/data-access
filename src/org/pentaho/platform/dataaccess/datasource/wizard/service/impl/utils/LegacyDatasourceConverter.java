...
/**
 * This class will convert legacy Connection class references to 5.0 IDatabaseConnection instances for
 * MultiTableDatasourceDTO objects' deserialization
 */
public class LegacyDatasourceConverter implements Converter {
        ...
        if ( connectionClass != null ) {
          ...
          if ( connectionClass.equals( "org.pentaho.platform.dataaccess.datasource.beans.Connection" ) ) {
            ...
            try {
              ...
              IDatabaseConnection databaseConnectionInstance =
                (IDatabaseConnection) context.convertAnother( resultDTO, databaseConnectionClass );
  ...
  /**
   * Helper to parse a jdbc url and provide hostname, port, and database name as property values
   */
