...
public class PhysicalStep extends AbstractWizardStep<DatasourceModel> implements IRelationalModelValidationListener, IModelInfoValidationListener {
  ...
  private static final List<String> ENCODINGS = Arrays.asList(new String [] { "","UTF-8","UTF-16BE","UTF-16LE","UTF-32BE","UTF-32LE","Shift_JIS","ISO-2022-JP","ISO-2022-CN","ISO-2022-KR","GB18030","Big5","EUC-JP","EUC-KR","ISO-8859-1","ISO-8859-2","ISO-8859-5","ISO-8859-6","ISO-8859-7","ISO-8859-8","windows-1251","windows-1256","KOI8-R","ISO-8859-9" });
  ...
  public void initializeModel(DatasourceModel model) {
    ...
    for (IDatasourceTypeController controller : datasourceTypeControllers) {
      if (controller.supportsBusinessData(model)) {
        controller.initializeBusinessData(model);
        break;
      }
    }
  }
  ...
  class NoopDatasourceController implements IDatasourceTypeController {
    ...
    /* (non-Javadoc)
     * @see org.pentaho.platform.dataaccess.datasource.wizard.controllers.IDatasourceTypeController#initializeBusinessData(org.pentaho.platform.dataaccess.datasource.beans.BusinessData)
     */
