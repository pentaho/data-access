...
public class AutobeanUtilities {
   ...
   * 
   * This method will take an autobean implementation of IDatabaseConnection and 
   ...
   * 
   * Conversion method for creating a Database Type from an Autobean implementation of
   * IDatabaseType
   */
